    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl shadow-xl p-6 mb-6 transform transition-all duration-300 ease-in-out hover:scale-[1.02]">
          ...
          <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl shadow-xl p-6">
        ...
        <div className="lg:w-80 lg:sticky lg:top-6 lg:self-start">
          <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl shadow-xl p-6 mb-6">
            {/* Picks History */}
            <div>
              ...
              <div className="space-y-3">
                {picks.map((pick, index) => (
                  <div key={index} className="bg-gradient-to-b from-gray-700/50 to-gray-800/50 backdrop-blur-sm rounded-lg p-3 flex items-center gap-3">
